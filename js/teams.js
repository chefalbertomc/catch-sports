const SPORTS_CATALOG = [
  ...
  },
  {
    ...
    leagues: [
      {
        league: "Liga MX",
        leagueLogo: "https://upload.wikimedia.org/wikipedia/commons/e/e9/Liga_MX_logo.svg",
        teams: [
          { id: "soc-america", name: "Club América", logo: "https://upload.wikimedia.org/wikipedia/commons/1/1b/Club_Am%C3%A9rica_logo.svg" },
          { id: "soc-chivas", name: "Chivas Guadalajara", logo: "https://upload.wikimedia.org/wikipedia/en/4/43/CD_Guadalajara_logo.svg" },
          { id: "soc-cruzazul", name: "Cruz Azul", logo: "https://upload.wikimedia.org/wikipedia/commons/4/4a/Cruz_Azul_Logo.svg" },
          { id: "soc-pumas", name: "Pumas UNAM", logo: "https://upload.wikimedia.org/wikipedia/commons/7/77/Pumas_UNAM.svg" },
          { id: "soc-tigres", name: "Tigres UANL", logo: "https://upload.wikimedia.org/wikipedia/commons/d/df/Tigres_UANL_logo.svg" },
          { id: "soc-monterrey", name: "Rayados de Monterrey", logo: "https://upload.wikimedia.org/wikipedia/commons/c/c2/CF_Monterrey_logo.svg" },
          { id: "soc-toluca", name: "Toluca FC", logo: "https://upload.wikimedia.org/wikipedia/commons/b/b3/Deportivo_Toluca_FC_logo.svg" },
          { id: "soc-leon", name: "Club León", logo: "https://upload.wikimedia.org/wikipedia/commons/6/6f/Club_Le%C3%B3n_logo.svg" },
          { id: "soc-santos", name: "Santos Laguna", logo: "https://upload.wikimedia.org/wikipedia/commons/8/87/Club_Santos_Laguna_logo.svg" },
          { id: "soc-pachuca", name: "Pachuca", logo: "https://upload.wikimedia.org/wikipedia/commons/a/aa/CF_Pachuca_logo.svg" },
          { id: "soc-atlas", name: "Atlas FC", logo: "https://upload.wikimedia.org/wikipedia/commons/a/a8/Atlas_FC_logo.svg" },
          { id: "soc-puebla", name: "Club Puebla", logo: "https://upload.wikimedia.org/wikipedia/commons/9/90/Club_Puebla_logo.svg" },
          { id: "soc-tijuana", name: "Xolos de Tijuana", logo: "https://upload.wikimedia.org/wikipedia/commons/0/07/Club_Tijuana_logo.svg" },
          { id: "soc-necaxa", name: "Rayos del Necaxa", logo: "https://upload.wikimedia.org/wikipedia/commons/e/e0/Club_Necaxa_logo.svg" },
          { id: "soc-sanluis", name: "Atlético de San Luis", logo: "https://upload.wikimedia.org/wikipedia/commons/3/3b/Atl%C3%A9tico_San_Luis_logo.svg" },
          { id: "soc-mazatlan", name: "Mazatlán FC", logo: "https://upload.wikimedia.org/wikipedia/commons/a/ab/Mazatl%C3%A1n_F.C._logo.svg" },
          { id: "soc-juarez", name: "Bravos de Juárez", logo: "https://upload.wikimedia.org/wikipedia/commons/8/8d/FC_Ju%C3%A1rez_logo.svg" },
          { id: "soc-queretaro", name: "Gallos Blancos de Querétaro", logo: "https://upload.wikimedia.org/wikipedia/commons/e/ea/Quer%C3%A9taro_FC_logo.svg" }
        ]
      },
      {
